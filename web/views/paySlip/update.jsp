                            ...
                            <div class="white-box">
                                ...
                                <form action="<c:url value="/paySlip/update_handler.do"/>" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input disabled type="text" placeholder="Salary" value="<fmt:formatNumber value='${paySlip.salary}' type='currency' currencySymbol='₫' maxFractionDigits='0' />"
                                                   class="form-control form-control-line" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Bonus" name="bonus"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input disabled type="text" placeholder="Minus" value="<fmt:formatNumber value='${paySlip.minus}' type='currency' currencySymbol='₫' maxFractionDigits='0' />"
                                                   class="form-control form-control-line" />
