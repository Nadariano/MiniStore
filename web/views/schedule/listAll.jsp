                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <c:forEach var="listItem" items="${weeks}" varStatus="loop">
                                            <li class="col-sm-12"><a href="<c:url value="/schedule/selectWeek.do?op=filter&week=${selectedWeek=listItem}"/>" ${listItem==weeks[2] ? 'selected':''}>${listItem}</a></li>
                                            </c:forEach>
                                    </ul>
                                </div>     
                                ...
                                <c:forEach var="i" begin="0" end="${fn:length(listDays) - 1}" step="1" >
                                    <td> 
                                        ...
                                        <button class="btn-primary">
                                            <a href="<c:url value="/userShift/create.do"/>">
